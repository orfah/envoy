...
TEST_F(RouteConfigProviderManagerImplTest, ConfigDump) {
  auto message_ptr = factory_context_.admin_.config_tracker_.config_tracker_callback_();
...
virtual_hosts:
  ...
  message_ptr = factory_context_.admin_.config_tracker_.config_tracker_callback_();
